...
// Absent, remediation messages fall back to a `node <path>` form that is right in every repo and
// idiomatic in none. Optional rather than core so a host adopting two checks needs no scripts at all.
export const OPTIONAL_CONFIG_NAMES = Object.freeze(['SCRIPTS']);
...
const SHAPES = Object.freeze({
  ...
  SCRIPTS: [
    'an object of this repo’s script names',
    value =>
