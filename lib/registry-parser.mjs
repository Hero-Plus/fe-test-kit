...
export function makeRegistryParser({
  ...
  listPageRelative,
  listRowsKey,
  // Widened, never narrowed: this parser emits `detail` and `list` cells and nothing else, so a
  // vocabulary missing either contradicts its own cells and `cell-map` exits 2 on the disagreement.
  views = ['detail', 'list'],
